...
public class FruitListAdapter extends RecyclerView.Adapter<FruitListAdapter.ListViewHolder>{
    private ArrayList<Fruit> listFruit;

    public FruitListAdapter(ArrayList<Fruit> list){
        this.listFruit = list;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull FruitListAdapter.ListViewHolder holder, int position) {
